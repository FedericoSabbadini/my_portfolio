            ...
            <div class="course-card ${type}">
                ...
                ${(course.url || course.hfUrl) ? `
                    <div class="course-footer">
                        ...
                        ${course.hfUrl ? ` <a href="${course.hfUrl}" target="_blank" class="link hf-link" title="View material on Hugging Face">📂</a>` : ''}
                    </div>
                ` : ''}
            </div>
        `).join('');
            ...
            <div class="featured-card featured-cert">
                ...
                ${(cert.url || cert.hfUrl) ? `
                    <div class="featured-footer">
                        ...
                        ${cert.hfUrl ? ` <a href="${cert.hfUrl}" target="_blank" class="link hf-link" title="View material on Hugging Face">📂</a>` : ''}
                    </div>
                ` : ''}
            </div>
        `).join('');
